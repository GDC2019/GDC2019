(function ($, window, document) {
	var defaults = {
		...
		// activeColor: 'rgb(244, 246, 248)', // 默认颜色
		then: function () {
	...
	TimeAxis.prototype = {
		...
		setTimeAxisHtml: function () {
			...
			$.each(list, function (index, item) {
				html += '<li>';
				html += '<div class="cx-main-box cx-main-box'+index+'" data-index="'+index+'"><div class = "tubiaologo"><div class = "tubiaologo-bg"><div>'+item.timeKeyNumber+'</div>'+item.timeKey+'</div></div><div class = "tubiaoRight">';
